...
st.title("Garage Tile Designer Manual v3.6")
...
# 4. DataFrame inicial o actualizado
...
# 7. Renderizar vista gráfica con borde global adaptativo
# Definir color de borde global según base
border_color = "#FFFFFF" if color_base == "Negro" else "black"
